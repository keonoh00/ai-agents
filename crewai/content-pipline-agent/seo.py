...
class SeoCrew:
    ...
    def seo_expert(self):
        return Agent(
            role="SEO Specialist",
            goal="Analyze blog posts for SEO optimization and provide a score with detailed reasoning. Be very very very demanding, don't give underserved good scores.",
