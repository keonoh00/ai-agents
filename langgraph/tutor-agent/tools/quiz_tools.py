...
from agents.common import OLLAMA_BASE_URL, OLLAMA_MODEL_NAME
...
class Question(BaseModel):
    question: str = Field("The quiz question to test")
...
def generate_quiz(
    ...
    """
    model = init_chat_model(model=OLLAMA_MODEL_NAME, base_url=OLLAMA_BASE_URL)
    ...
    Make sure yo use research information to create the most accurate questions.
    """
