...
async def generate_narrations(
    ...
    """
    Generates narration audio for a given voice and voice instructions.

    Args:
        voice: The voice to use for the narration.
        voice_instructions: A list of dictionaries containing the voice instructions for each scene.
    """
    ...
    for instruction in voice_instructions:
        text_input: str = instruction.get("input", "")
        instructions: str = instruction.get("instructions", "")
